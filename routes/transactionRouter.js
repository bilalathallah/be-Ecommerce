...
router.get("/buyer", userMiddleware.authorize, userMiddleware.isBuyyer, transactionController.listByBuyer);
  
router.get("/seller", userMiddleware.authorize, userMiddleware.isSeller, transactionController.listBySeller);
  
router.get("/buyer/:id", userMiddleware.authorize, userMiddleware.isBuyyer, transactionController.showByBuyer);
  
router.get("/seller/:id", userMiddleware.authorize, userMiddleware.isSeller, transactionController.showBySeller);
